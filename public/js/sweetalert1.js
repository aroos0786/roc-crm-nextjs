    ...
    jQuery("#auto-close").on("click", function () { 
        ...
        jQuery("#prompt-function").on("click", function () { 
            Swal.mixin({ 
                ...
                //      jQuery("#ajax-request").on("click", function () { 
                //          Swal.fire({ title: "Search for a user", 
                //          input: "text", confirmButtonClass: "btn btn-primary", 
                //          buttonsStyling: !1, 
                //          inputAttributes: { autocapitalize: "off" }, 
                //          showCancelButton: !0, confirmButtonText: "Look up", 
                //          showLoaderOnConfirm: !0, 
                //          cancelButtonClass: "btn btn-danger ml-1", 
                //          preConfirm: function (t) { return fetch("//api.github.com/users/" + t).then(function (t) { 
                //              if (!t.ok) throw console.log(t), new Error(t.statusText); return t.json() 
                //             }).catch(function (t) { 
